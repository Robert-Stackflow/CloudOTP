...
public class MiniWidgetProvider extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        ComponentName componentName = new ComponentName(context, MiniWidgetProvider.class);
    ...
    public static void updateWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        //列表点击事件
        Intent clickIntent = new Intent(context, MiniWidgetProvider.class).setAction(CLICK_ACTION);
