...
class CloudOtpTokenPayload extends $pb.GeneratedMessage {
  ...
  factory CloudOtpTokenPayload.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CloudOtpTokenPayload.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CloudOtpTokenPayload', createEmptyInstance: create)
    ..pc<CloudOtpTokenParameters>(1, _omitFieldNames ? '' : 'tokenParameters', $pb.PbFieldType.PM, subBuilder: CloudOtpTokenParameters.create)
  ...
  CloudOtpTokenPayload clone() => CloudOtpTokenPayload()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CloudOtpTokenPayload copyWith(void Function(CloudOtpTokenPayload) updates) => super.copyWith((message) => updates(message as CloudOtpTokenPayload)) as CloudOtpTokenPayload;
  ...
  static $pb.PbList<CloudOtpTokenPayload> createRepeated() => $pb.PbList<CloudOtpTokenPayload>();
  @$core.pragma('dart2js:noInline')
  static CloudOtpTokenPayload getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CloudOtpTokenPayload>(create);
...
class CloudOtpTokenParameters extends $pb.GeneratedMessage {
  ...
  factory CloudOtpTokenParameters.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CloudOtpTokenParameters.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CloudOtpTokenParameters', createEmptyInstance: create)
    ...
    ..e<CloudOtpTokenAlgorithm>(5, _omitFieldNames ? '' : 'algorithm', $pb.PbFieldType.OE, defaultOrMaker: CloudOtpTokenAlgorithm.ALGORITHM_TYPE_UNSPECIFIED, valueOf: CloudOtpTokenAlgorithm.valueOf, enumValues: CloudOtpTokenAlgorithm.values)
    ..e<CloudOtpTokenDigitCount>(6, _omitFieldNames ? '' : 'digits', $pb.PbFieldType.OE, defaultOrMaker: CloudOtpTokenDigitCount.DIGIT_COUNT_UNSPECIFIED, valueOf: CloudOtpTokenDigitCount.valueOf, enumValues: CloudOtpTokenDigitCount.values)
    ..e<CloudOtpTokenType>(7, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: CloudOtpTokenType.OTP_TYPE_UNSPECIFIED, valueOf: CloudOtpTokenType.valueOf, enumValues: CloudOtpTokenType.values)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CloudOtpTokenParameters clone() => CloudOtpTokenParameters()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CloudOtpTokenParameters copyWith(void Function(CloudOtpTokenParameters) updates) => super.copyWith((message) => updates(message as CloudOtpTokenParameters)) as CloudOtpTokenParameters;
  ...
  static $pb.PbList<CloudOtpTokenParameters> createRepeated() => $pb.PbList<CloudOtpTokenParameters>();
  @$core.pragma('dart2js:noInline')
  static CloudOtpTokenParameters getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CloudOtpTokenParameters>(create);
  ...
  @$pb.TagNumber(5)
  set algorithm(CloudOtpTokenAlgorithm v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set digits(CloudOtpTokenDigitCount v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set type(CloudOtpTokenType v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set period($fixnum.Int64 v) { $_setInt64(7, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set counter($fixnum.Int64 v) { $_setInt64(8, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set pinned($fixnum.Int64 v) { $_setInt64(9, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set copyTimes($fixnum.Int64 v) { $_setInt64(10, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set lastCopyTimeStamp($fixnum.Int64 v) { $_setInt64(11, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set imagePath($core.String v) { $_setString(12, v); }
  @$pb.TagNumber(13)
