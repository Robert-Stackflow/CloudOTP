...
public class EmoticonsIndicatorView extends LinearLayout {
    ...
    public EmoticonsIndicatorView(Context context, AttributeSet attrs) {
        ...
        if (mDrawableNomal == null) {
            mDrawableNomal = AppCompatResources.getDrawable(getContext(), R.drawable.indicator_point_nomal);
        }
        if (mDrawableSelect == null) {
            mDrawableSelect = AppCompatResources.getDrawable(getContext(), R.drawable.indicator_point_select);
        }
        mLeftLayoutParams = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        mLeftLayoutParams.leftMargin = SizeUtil.dp2px(context, MARGIN_LEFT);
    }
