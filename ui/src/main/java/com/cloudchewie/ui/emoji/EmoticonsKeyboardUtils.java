...
public class EmoticonsKeyboardUtils {
    ...
    public static int getFontHeight(@NonNull TextView textView) {
    ...
    public static View getRootView(@NonNull Activity context) {
        return ((ViewGroup) context.findViewById(android.R.id.content)).getChildAt(0);
    }

    public static int getDefKeyboardHeight(Context context) {
        if (sDefKeyboardHeight < 0) {
            sDefKeyboardHeight = SizeUtil.dp2px(context, DEF_KEYBOARD_HEAGH_WITH_DP);
        }
