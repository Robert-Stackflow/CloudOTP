package com.cloudchewie.ui.emoji.adapter;
...
public class EmoticonsAdapter<T> extends BaseAdapter {
    ...
    public EmoticonsAdapter(Context context, EmoticonPageEntity emoticonPageEntity, EmoticonClickListener onEmoticonClickListener) {
        ...
        this.mDefalutItemHeight = this.mItemHeight = (int) context.getResources().getDimension(R.dimen.dp30);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.item_emoji_icon, null);
