...
public class VerticalIconTextItem extends ConstraintLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attr != null) {
            iconId = attr.getResourceId(R.styleable.VerticalIconTextItem_vertical_icon_text_item_icon, R.drawable.ic_material_add);
            ...
            checkedIconId = attr.getResourceId(R.styleable.VerticalIconTextItem_vertical_icon_text_item_checked_icon, R.drawable.ic_material_add);
