...
public class RightDiaView extends View {
    ...
    private void drawStatic(Canvas canvas) {
        ...
        canvas.drawLine(center1, center,
                center1 + (float) radius / 3, center + (float) radius / 3, mPaint);
        canvas.drawLine(center1 + (float) radius / 3 - 1, center + (float) radius / 3 - 4,
                center1 + radius, center - (float) radius / 3, mPaint);
    }
