...
import 'flutter_googledrive.dart';
...
class DefaultTokenManager extends ITokenManager {
  ...
  static const String _expireInKey = "__googledrive_tokenExpire";
  static const String _accessTokenKey = "__googledrive_accessToken";
  static const String _refreshTokenKey = "__googledrive_refreshToken";

  DefaultTokenManager({
    required this.tokenEndpoint,
    required this.clientID,
    required this.redirectURL,
    this.scope = GoogleDrive.permission,
  });
