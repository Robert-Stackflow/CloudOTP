...
class _FABDefaultsM3 extends FloatingActionButtonThemeData {
  ...
  @override
  Color? get splashColor => _colors.onPrimaryContainer.withValues(alpha: 0.1);

  @override
  Color? get focusColor => _colors.onPrimaryContainer.withValues(alpha: 0.1);

  @override
  Color? get hoverColor => _colors.onPrimaryContainer.withValues(alpha: 0.08);
