...
/// always clip splashes, see [MyInkWell].
///
/// An [MyInkResponse] widget does two things when responding to a tap:
///
...
///    [MyInkResponse]. If it is [BoxShape.rectangle], then the highlight is a box
///    the size of the [MyInkResponse] itself, unless [getRectCallback] is
...
///    grows.
///
/// The following two diagrams show how [MyInkResponse] looks when tapped if the
/// [highlightShape] is [BoxShape.circle] (the default) and [containedInkWell]
/// is false (also the default).
///
/// The first diagram shows how it looks if the [MyInkResponse] is relatively
/// large:
///
...
///
/// The second diagram shows how it looks if the [MyInkResponse] is small:
///
...
///
/// The following diagram shows the effect when the [MyInkResponse] has a
/// [highlightShape] of [BoxShape.rectangle] with [containedInkWell] set to
/// true. These are the values used by [MyInkWell].
///
...
///
/// The [MyInkResponse] widget must have a [Material] widget as an ancestor. The
...
/// [DecoratedBox], between the [Material] widget and the [MyInkResponse] widget,
...
/// [Material] above the opaque widget but below the [MyInkResponse] (as an
...
///  * [IconButton], which combines [MyInkResponse] with an [Icon].
class MyInkResponse extends StatelessWidget {
  ...
  /// [MyInkResponse] or not. If [containedInkWell] is true, the splash remains
  /// centered around the tap location. If it is false, the splash migrates to
  /// the center of the [MyInkResponse] as it grows.
  ///
  /// See also:
  ///
  ...
  /// [MyInkResponse]. If the shape is [BoxShape.rectangle], then the highlight
  /// fills the [MyInkResponse], or the rectangle provided by [getRectCallback] if
  ...
  /// specialize [MyInkResponse] for unusual cases. For example,
            ...
            child: DefaultSelectionStyle.merge(
              ...
              child: Semantics(
                ...
                child: GestureDetector(
                  ...
                  onLongPressUp:
                      widget.onLongPressUp != null ? handleLongPressUp : null,
                  onSecondaryTapDown:
...
///
/// For a variant of this widget that does not clip splashes, see [MyInkResponse].
///
/// The following diagram shows how an [MyInkWell] looks when tapped, when using
/// default values.
///
/// ![The highlight is a rectangle the size of the box.](https://flutter.github.io/assets-for-api-docs/assets/material/ink_well.png)
///
/// The [MyInkWell] widget must have a [Material] widget as an ancestor. The
/// [Material] widget is where the ink reactions are actually painted. This
/// matches the Material Design premise wherein the [Material] is what is
/// actually reacting to touches by spreading ink.
///
...
///
/// If there is an opaque graphic, e.g. painted using a [Container], [Image], or
/// [DecoratedBox], between the [Material] widget and the [MyInkWell] widget, then
...
/// If this is not possible for some reason, e.g. because you are using an
/// opaque [CustomPaint] widget, alternatively consider using a second
/// [Material] above the opaque widget but below the [MyInkWell] (as an
...
///  * [GestureDetector], for listening for gestures without ink splashes.
///  * [ElevatedButton] and [TextButton], two kinds of buttons in Material Design.
///  * [MyInkResponse], a variant of [MyInkWell] that doesn't force a rectangular
///    shape on the ink reaction.
class MyInkWell extends MyInkResponse {
  /// Creates an ink well.
  ///
  /// Must have an ancestor [Material] widget in which to cause ink reactions.
  const MyInkWell({
