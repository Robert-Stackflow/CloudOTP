...
///
/// PinPutValidateAsyncController is a controller for [Pinput] that allows you to validate the input asynchronously.
///
class PinPutValidateAsyncController {
  /// The controller for the [Pinput] widget.
  TextEditingController controller;

  /// The error message to display if the input is invalid.
  String? errorMessage;

  /// The validator function that will be called to validate the input.
  Future<String?> Function(String) validator;

  /// The function that will be called when an error occurs.
  void Function() onError = () {};

  /// The function that will be called when the input is valid.
  Function()? doPop;

  /// Whether the controller should listen for changes.
  final bool listen;

  /// Creates a new [PinPutValidateAsyncController] with the given parameters.
  PinPutValidateAsyncController({
    this.errorMessage,
  ...
  void setController(TextEditingController controller) {
    ...
    if (listen) {
      this.controller.addListener(validate);
    }
  }
...
class Pinput extends StatefulWidget {
  ...
  /// Controller for validating the input asynchronously.
  final PinPutValidateAsyncController? validateAsyncController;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
      DiagnosticsProperty<PinPutValidateAsyncController>(
