...
class _PinputState extends State<Pinput>
  ...
  String? get _errorMessage => widget.validateAsyncController?.errorMessage;

  String? get _errorText =>
      _errorMessage ?? widget.errorText ?? _validatorErrorText;
  ...
  void initState() {
    ...
    widget.validateAsyncController?.setController(_effectiveController);
      ...
      child: AnimatedBuilder(
        ...
        builder: (BuildContext context, Widget? child) {
          final shouldHideErrorContent =
              widget.validator == null && _errorText == null;
  ...
  // && (!hasFocus || widget.forceErrorState)
