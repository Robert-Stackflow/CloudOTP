...
class TableConfig implements ContainerConfig {
  ...
  final Decoration? bodyOddRowDecoration;
  final Decoration? bodyEvenRowDecoration;
  ...
  const TableConfig({
    ...
    this.bodyOddRowDecoration,
    this.bodyEvenRowDecoration,
    this.headerStyle,
    this.bodyStyle,
    this.wrapper,
...
class TBodyNode extends ElementNode {
  ...
  List<TableRow> buildRows(int cellCount) {
    return List.generate(children.length, (index) {
      ...
      var decoration = config.table.bodyRowDecoration;
      if (config.table.bodyOddRowDecoration != null && index.isOdd) {
        decoration = config.table.bodyOddRowDecoration;
      } else if (config.table.bodyEvenRowDecoration != null && index.isEven) {
        decoration = config.table.bodyEvenRowDecoration;
      }
      return TableRow(
